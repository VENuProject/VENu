...
public var scalingFactor : float; //= 0.4f * slidr.value;
...
*/
        ...
        var pt1 : Vector3 = Vector3(
            0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][0][0].AsFloat,
            0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][0][1].AsFloat,
           -0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][0][2].AsFloat);
        var pt2 : Vector3 = Vector3(
            0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][1][0].AsFloat,
        ...
        for (var spacePointIndex : int = 2; spacePointIndex < totalPoints; spacePointIndex++) {
            var vec : Vector3 = Vector3(
                0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][spacePointIndex][0].AsFloat,
                0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][spacePointIndex][1].AsFloat,
               -0.1*scalingFactor*N["record"]["tracks"][trackAlgoName][trackIndex]["points"][spacePointIndex][2].AsFloat);
